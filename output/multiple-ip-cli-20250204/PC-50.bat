...
:: IP Range: 172.17.0.1 - 172.17.0.61
:: Subnet Mask: 255.255.252.0
:: Gateway: 172.17.1.254
echo Configuring Network 17 IPs for PC 50...
...
:: IP Range: 172.18.0.1 - 172.18.0.61
:: Subnet Mask: 255.255.252.0
:: Gateway: 172.18.1.254
echo Configuring Network 18 IPs for PC 50...
FOR /L %%A IN (1,1,61) DO (
...
:: ========================================
echo Configuration completed for PC 50!
