...
:: IP Range: 172.17.1.62 - 172.17.1.122
:: Subnet Mask: 255.255.252.0
:: Gateway: 172.17.1.254
echo Configuring Network 17 IPs for LAPTOP 60...
FOR /L %%A IN (62,1,122) DO (
...
:: IP Range: 172.18.1.62 - 172.18.1.122
:: Subnet Mask: 255.255.252.0
:: Gateway: 172.18.1.254
echo Configuring Network 18 IPs for LAPTOP 60...
FOR /L %%A IN (62,1,122) DO (
...
:: ========================================
echo Configuration completed for LAPTOP 60!
