...
:: IP Range: 172.17.0.62 - 172.17.0.122
:: Subnet Mask: 255.255.252.0
:: Gateway: 172.17.1.254
echo Configuring Network 17 IPs for LAPTOP 57...
...
:: IP Range: 172.18.0.62 - 172.18.0.122
:: Subnet Mask: 255.255.252.0
:: Gateway: 172.18.1.254
echo Configuring Network 18 IPs for LAPTOP 57...
FOR /L %%A IN (62,1,122) DO (
...
:: ========================================
echo Configuration completed for LAPTOP 57!
